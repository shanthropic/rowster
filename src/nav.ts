...
const LOCALHOST_RE =
  /^(?:localhost|127\.0\.0\.1)(?::\d+)?$|^\[?::1\]?$|^10\.\d+\.\d+\.\d+(?::\d+)?$|^192\.168\.\d+\.\d+(?::\d+)?$|^172\.(?:1[6-9]|2\d|3[01])\.\d+\.\d+(?::\d+)?$/;

const SCHEME_RE = /^[a-zA-Z][a-zA-Z0-9+.-]*:/;

/** Adds http/https only for host-like input; Rust resolves all other input as search. */

/**
 * Rowster Theme — Material You (monochrome)
 *
...
export const rowsterTheme = defineTheme({
  name: 'rowster',
  ...
  // Motion: Material 3 emphasis durations — fast 200ms, medium 300ms,
  // slow 500ms. Produces: fast-min=150ms, fast=200ms, fast-max=266ms,
  //                       medium-min=225ms, medium=300ms, medium-max=400ms.
  motion: {fast: 200, medium: 300, slow: 500, ratio: 0.75},
  ...
  tokens: {
    ...
    // =========================================================================
    // Radius — Material Design 3 shape scale (monochrome keeps the M3
    // baseline): none 0 / inner 4 (fields, small controls) / element 8
    // (buttons, chips, segmented) / container 12 (cards, dialogs) / page 28
    // (dialogs, sheets) / chat 16 (M3 "large" — message bubbles).
    // =========================================================================
    '--radius-none': '0px',
    '--radius-inner': '4px',
    '--radius-element': '8px',
  ...
  components: {
    // =========================================================================
    // Button — M3 filled-button shape (20px, "rounded" style); primary gets
    // white text, secondary gets a border, destructive uses the OKLCH red
    // filled treatment.
    // =========================================================================
    button: {
      base: {
